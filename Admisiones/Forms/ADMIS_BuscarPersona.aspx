<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Principal.Master" AutoEventWireup="true" CodeBehind="ADMIS_BuscarPersona.aspx.cs" Inherits="Admisiones.Forms.ADMIS_BuscarPersona" %>
                                                ...
                                                <div class="form-group">
                                                    <asp:GridView ID="gvUsuarios" runat="server" CssClass="table table-striped table-bordered table-hover input-sm" AutoGenerateColumns="False" PageSize="15" OnRowCommand="gvDatos1_RowCommand" >
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="num_sec_persona" HeaderText="ns_Persona" />
