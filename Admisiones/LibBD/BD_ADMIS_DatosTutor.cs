...
namespace Admisiones
{
    ...
    public class BD_ADMIS_DatosTutor : iBD_Tablas
    {
        ...
        public bool Ver()
        {
            ...
            {
                strSql = "select *, to_char(FECHA_NACIMIENTO, 'dd/mm/yyyy') as fecha_nacimiento_formato, to_char(FECHA_REGISTRO_FORMATO, 'dd/mm/yyyy') as FECHA_REGISTRO_FORMATO" +
                         " from ADMIS_DATOS_PERSONALES " +
        ...
        public string cadSqlInsertar()
        {
            strSql = "insert into ADMIS_DATOS_TUTOR " +
                        ...
                        " AVENIDA_CALLE, NUMERO, ZONA, TELEFONO, CELULAR, CORREO_ELECTRONICO, NUM_SEC_PERSONA,  " +
                        ...
                        "'" + _email + "'," +
                        _num_sec_persona +","+
                        "'" + _institucion_trabajo + "'," +
                        "'" + _cargo + "'," +
                        "'" + _telefono_trabajo + "'," +
                        "'" + _autorizacion_seguimiento + "'," +
                        " sysdate, " +
                        "'" + _usuario_registro + "')";
            return strSql;
        }
        public string cadSqlActualizar()
        {
            strSql = "update ADMIS_DATOS_TUTOR set " +
                        ...
                        " ,DOC_IDENTIDAD='" + _documento_identidad + "'" +
                        " ,TIPO_DOC=" + _tipo_doc +
                        " ,GENERO=" + _genero +
                        " ,TIPO_TUTOR=" + _tipo_tutor +
                        " ,AVENIDA_CALLE='" + _avenida_calle + "'" +
                        " ,NUMERO='" + _numero + "'" +
                        " ,ZONA='" + _zona + "'" +
                        " ,TELEFONO=" + _telefono +
                        " ,CELULAR='" + _celular + "'" +
                        " ,CORREO_ELECTRONICO='" + _email + "'" +
                        " ,NUM_SEC_PERSONA=" + _num_sec_persona +
                        " ,INSTITUCION_TRABAJO =  '" +_institucion_trabajo+"'"+
                        " ,CARGO='" + _cargo +"'"+
                        " ,TELEFONO_TRABAJO='" + _telefono_trabajo +"'"+
                        " ,AUTORIZACION_SEGUIMIENTO= " + _autorizacion_seguimiento +
                        " ,FECHA_REGISTRO=sysdate" +
                        " ,USUARIO_REGISTRO='" + _usuario_registro + "'" +
                        " where num_sec_datos_personales = " + _num_sec_datos_personales;
            return strSql;
        }
        #endregion
    }
